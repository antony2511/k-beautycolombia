    ...
    try {
      ...
      if (response.ok && data.post) {
        ...
        setFormData({
          ...
          skinType: (post.skinType as string[]) || [],
          brands: (post.brands as string[]) || [],
          relatedProductIds: (post.relatedProductIds as string[]) || [],
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-primary">Editar Artículo</h1>
